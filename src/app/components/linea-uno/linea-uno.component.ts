...
@Component({
  selector: 'app-linea-uno',
  templateUrl: './linea-uno.component.html',
  styleUrls: ['./linea-uno.component.scss']
})
export class LineaUnoComponent{

  constructor() { }
  title = 'Crédito línea 1'
  form = new FormGroup({})
...
//-----------------------------------------------------------------------------------------------------------------
  ...
  // GRUPO FAMILIAR
  {
    ...
    type: 'no repeat',
    templateOptions:{
      addText: 'Agregar tabla grupo familiar'
    },
    fieldArray:{
      fieldGroup:[
        {
  ...
  {
    className: 'datos-integrante-garante',
    template: '<div><h2>Datos del integrante y garante.</h2></div>',
  },
  {
    key: 'Integrantes y garantes',
    type: 'repeat',
    templateOptions: {
      addText: 'Agregar integranto y garante',
    },
    fieldArray: {
      fieldGroup: [
        {
        ...
        {template:'<h3>Datos domiciliarios</h3>'},
        {
          key: 'Calle',
          type: 'input',
          templateOptions:{
        ...
        {template:'<h3>Información de contacto</h3>'},
        {
          key: 'Teléfono',
          type: 'input',
          templateOptions:{
